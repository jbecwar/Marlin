...
#define TEMP_SENSOR_0 1 //  Could be 5 or  7
...
#define DELTA
  ...
  #define DELTA_CARRIAGE_OFFSET 17.75  //19.5 // mm

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET))

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 85.0  //90
...
#define MANUAL_Z_HOME_POS 99.8 //250 // Distance between the nozzle to printbed after homing
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,200,200, 630} //{80, 80, 80, 760*1.1}  // default steps per unit for Kossel (GT2, 20 tooth)
